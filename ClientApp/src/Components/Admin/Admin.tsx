...
export default function Admin(props: Props){
    ...
    //const match = RouteMatch('/users/:id');
    
    let menu;
   
//     if (switcher == "versions"){
//         menu = (
//             <Versions />
//         );
//     }

//     else if (switcher == "dashboard"){
//         menu = (
//             <div>
